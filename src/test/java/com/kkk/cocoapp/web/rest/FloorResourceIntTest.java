...
public class FloorResourceIntTest {
    ...
    private static final Integer DEFAULT_FLOOR_ID = 1;
    private static final Integer UPDATED_FLOOR_ID = 2;
    ...
    public void createFloor() throws Exception {
        ...
        assertThat(testFloor.getFloorId()).isEqualTo(DEFAULT_FLOOR_ID);
        assertThat(testFloor.getBuildingId()).isEqualTo(DEFAULT_BUILDING_ID);
        assertThat(testFloor.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    ...
    public void getAllFloors() throws Exception {
        ...
        restFloorMockMvc.perform(get("/api/floors?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].floorId").value(hasItem(DEFAULT_FLOOR_ID)))
            .andExpect(jsonPath("$.[*].buildingId").value(hasItem(DEFAULT_BUILDING_ID)))
            .andExpect(jsonPath("$.[*].description").value(hasItem(DEFAULT_DESCRIPTION.toString())))
            .andExpect(jsonPath("$.[*].floorName").value(hasItem(DEFAULT_FLOOR_NAME.toString())));
    }
    ...
    public void getFloor() throws Exception {
        ...
        restFloorMockMvc.perform(get("/api/floors/{id}", floor.getId()))
            ...
            .andExpect(jsonPath("$.floorId").value(DEFAULT_FLOOR_ID))
            .andExpect(jsonPath("$.buildingId").value(DEFAULT_BUILDING_ID))
            .andExpect(jsonPath("$.description").value(DEFAULT_DESCRIPTION.toString()))
            .andExpect(jsonPath("$.floorName").value(DEFAULT_FLOOR_NAME.toString()));
    }
    ...
    public void updateFloor() throws Exception {
        ...
        Floor testFloor = floorList.get(floorList.size() - 1);
        assertThat(testFloor.getFloorId()).isEqualTo(UPDATED_FLOOR_ID);
        assertThat(testFloor.getBuildingId()).isEqualTo(UPDATED_BUILDING_ID);
        assertThat(testFloor.getDescription()).isEqualTo(UPDATED_DESCRIPTION);

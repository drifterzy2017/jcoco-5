...
import  com.kkk.cocoapp.service.*; //add by kkk
...
public class DeviceResource {
    ...
    @Timed
    public List<DeviceStatusStatistics> GetDeviceStatistics(){
        log.debug("REST request to get Device Statistics info");

        ArrayList<DeviceStatusStatistics> result = deviceService.getDeviceStatusStatistics();
        return  result;
    }
}
